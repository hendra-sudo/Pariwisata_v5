    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <form role="form" action="{{ url('master/wisata_new/add') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="box-body">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Wisata URL</label>
                        <input type="text" name="url_video" class="form-control" id="exampleInputEmail1" placeholder="Wisata URL" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama" class="form-control" id="exampleInputEmail1" placeholder="Nama Wisata" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="wisata_tag" class="form-control" id="exampleInputEmail1" placeholder="Wisata Tag" required>
                      </div>

                      <div class="form-group">
                        <label for="exampleInputEmail1">HTM Lokal</label>
                        <input type="number" name="htm_lokal" class="form-control" id="exampleInputEmail1" placeholder="Rp 10.000,-" required>
                      </div>
