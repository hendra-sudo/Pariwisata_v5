        ...
        <div class="row">
            <div class="col-md-8">
                <div class="row">
                    ...
                    // $wisata = \DB::table('m_wisata')->orderby('created_at','desc')->get();
                    ...
                    <div class="col-md-12">
                        <div class="post post-row">
                            ...
                            <div class="post-body">
                                <div class="post-meta">
                                    <a class="post-category cat-2" href="category.html">{{ $dt->kategori}}</a>
                ...
                <div class="aside-widget">
                    ...
                    <div class="category-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ url('wisata/kategori/'.$kt->kategori_id)}}" class="cat-2">{{ $kt->kategori_nama }}</a></li>
