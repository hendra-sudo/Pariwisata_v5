...
<ol class="breadcrumb">
    ...
    <li><a href="#">Tambah Cinderamata</a></li>
    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <form role="form" action="{{ url('master/cinderamata/add') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_cinderamata"  class="form-control" id="exampleInputEmail1" placeholder="Nama Cinderamata" required>
                      </div>
