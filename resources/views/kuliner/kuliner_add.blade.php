    ...
    <div class="col-md-12">
        ...
        <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <form role="form" action="{{ url('master/kuliner/add') }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_kuliner"  class="form-control" id="exampleInputEmail1" placeholder="Nama kuliner" required>
                      </div>
